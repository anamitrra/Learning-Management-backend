<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <x-primary-button-link :href="route('course.create')">Add +
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-5">
            ...
            <table id="table" class="display" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><img src="{{ asset('storage/'.$course->course_image) }}" alt="image" width="100"></td>
                        <td>{{ $course->course_name }}</td>
                        <td>
                            <x-primary-button-link :href="route('course.edit', ['course' => 
                        $course->id])">Edit
                            </x-primary-button-link>
                        </td>
                    </tr>
